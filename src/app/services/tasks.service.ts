...
export class TasksService {
  tasks = signal<Task[]>([
    ...
    { id: 2, user_id: 'u1', task: 'Take out the trash', status: false },
    {
      id: 3,
      user_id: 'u2',
    ...
    { id: 7, user_id: 'u4', task: 'Water the plants', status: false },
    { id: 8, user_id: 'u4', task: 'Clean the kitchen', status: false },
    { id: 9, user_id: 'u5', task: 'Buy groceries', status: false },
    { id: 10, user_id: 'u5', task: 'Organize the closet', status: false },
    ...
    { id: 15, user_id: 'u8', task: 'Respond to emails', status: false },
    {
      id: 16,
      user_id: 'u9',
    ...
    { id: 19, user_id: 'u11', task: 'Plan the weekend trip', status: false },
